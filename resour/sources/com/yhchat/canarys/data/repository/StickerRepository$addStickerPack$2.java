...
@DebugMetadata(m184c = "com.yhchat.canarys.data.repository.StickerRepository$addStickerPack$2", m185f = "StickerRepository.kt", m186i = {1, 1}, m187l = {LocationRequestCompat.QUALITY_BALANCED_POWER_ACCURACY, 109}, m188m = "invokeSuspend", m189n = {"token", "request"}, m191s = {"L$0", "L$1"}, m192v = 1)
/* loaded from: classes12.dex */
final class StickerRepository$addStickerPack$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends Boolean>>, Object> {
    ...
    StickerRepository$addStickerPack$2(StickerRepository stickerRepository, long j, Continuation<? super StickerRepository$addStickerPack$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new StickerRepository$addStickerPack$2(this.this$0, this.$packId, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Result<Boolean>> continuation) {
        return ((StickerRepository$addStickerPack$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r9) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yhchat.canarys.data.repository.StickerRepository$addStickerPack$2.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
