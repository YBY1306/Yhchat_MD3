...
@DebugMetadata(m184c = "com.yhchat.canarys.ui.profile.EmailModificationViewModel$getEmailVerificationCode$response$1", m185f = "EmailModificationViewModel.kt", m186i = {}, m187l = {71}, m188m = "invokeSuspend", m189n = {}, m191s = {}, m192v = 1)
/* loaded from: classes16.dex */
final class EmailModificationViewModel$getEmailVerificationCode$response$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Response<Map<String, ? extends Object>>>, Object> {
    ...
    EmailModificationViewModel$getEmailVerificationCode$response$1(String str, String str2, String str3, Continuation<? super EmailModificationViewModel$getEmailVerificationCode$response$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new EmailModificationViewModel$getEmailVerificationCode$response$1(this.$email, this.$captchaCode, this.$captchaId, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Response<Map<String, Object>>> continuation) {
        return ((EmailModificationViewModel$getEmailVerificationCode$response$1) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
