...
@DebugMetadata(m184c = "com.yhchat.canarys.data.repository.ExpressionRepository$topExpression$2", m185f = "ExpressionRepository.kt", m186i = {1, 1}, m187l = {133, 140}, m188m = "invokeSuspend", m189n = {"token", "request"}, m191s = {"L$0", "L$1"}, m192v = 1)
/* loaded from: classes12.dex */
final class ExpressionRepository$topExpression$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Result<? extends Boolean>>, Object> {
    ...
    ExpressionRepository$topExpression$2(ExpressionRepository expressionRepository, long j, Continuation<? super ExpressionRepository$topExpression$2> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new ExpressionRepository$topExpression$2(this.this$0, this.$expressionId, continuation);
    }
    ...
    public final Object invoke2(CoroutineScope coroutineScope, Continuation<? super Result<Boolean>> continuation) {
        return ((ExpressionRepository$topExpression$2) create(coroutineScope, continuation)).invokeSuspend(Unit.INSTANCE);
    }
    ...
    */
    public final java.lang.Object invokeSuspend(java.lang.Object r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.yhchat.canarys.data.repository.ExpressionRepository$topExpression$2.invokeSuspend(java.lang.Object):java.lang.Object");
    }
}
