...
public abstract class Hilt_LoginActivity extends BaseActivity implements GeneratedComponentManagerHolder {
    ...
    /* renamed from: com.yhchat.canarys.ui.login.Hilt_LoginActivity$1 */
    class C40321 implements OnContextAvailableListener {
        C40321() {
        }
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: com.yhchat.canarys.ui.login.Hilt_LoginActivity.1
            C40321() {
            }
