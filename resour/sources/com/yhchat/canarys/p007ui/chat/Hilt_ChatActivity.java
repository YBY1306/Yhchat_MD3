...
public abstract class Hilt_ChatActivity extends BaseActivity implements GeneratedComponentManagerHolder {
    ...
    private void _initHiltInternal() {
        addOnContextAvailableListener(new OnContextAvailableListener() { // from class: com.yhchat.canarys.ui.chat.Hilt_ChatActivity.1
    ...
    protected void inject() {
        if (!this.injected) {
            this.injected = true;
            ((ChatActivity_GeneratedInjector) generatedComponent()).injectChatActivity((ChatActivity) UnsafeCasts.unsafeCast(this));
        }
    }
