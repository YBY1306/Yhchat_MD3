...
fun MessageSelectionContainer(
    ...
    val customToolbar = remember(view, defaultToolbar, onQuote, onEdit, onDelete, onPlusOne) {
        CustomTextToolbar(
            view = view,
...
private class CustomTextToolbar(
    ...
    override fun showMenu(
        ...
        actionMode = view.startActionMode(object : ActionMode.Callback2() {
            override fun onCreateActionMode(mode: ActionMode, menu: Menu): Boolean {
                ...
                onDelete?.let {
                    menu.add(0, MENU_ITEM_DELETE, 13, "撤回")
    ...
    companion object {
        ...
        private const val MENU_ITEM_DELETE = 1004
    }
}
